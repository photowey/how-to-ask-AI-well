...
If you do not want to wait, you can run a **minimal version** now: pick one real task from your own work, write two or three structurally different prompts using Chapters 18–20 as a checklist, run them in your usual tool, and compare. That is the smallest hands-on lab this part was written to support.
